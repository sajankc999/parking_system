...
urlpatterns = [
    ...
    path("parkingSpace/info/<pk>/", ParkingSpaceInfoView,
         name="parking_space_info"),
    path(
        "parkingSpace/change/<pk>/", ParkingSpaceChangeView, name="parking_space_edit"
    ),
    path(
        "parkingSpace/delete/<pk>/", ParkingSpaceDeleteView, name="parking_space_delete"
    ),
    path("parkingSpace/create/", ParkingSpaceCreateView,
         name="parking_space_create"),
    ...
    path(
        "vehicle_details/delete/<pk>", VehicleDetailDelete, name="vehicle_name_delete"
    ),
